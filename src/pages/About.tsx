      ...
      <section className="py-20 bg-gradient-to-b from-surface-darker to-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6">
            About <span className="text-gradient">GROWNETIX</span>
          </h1>
          <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto">
            We believe every small business deserves access to the same powerful digital tools 
            that large corporations use. That's why we created GROWNETIX.
          </p>
        </div>
      </section>
            ...
            <Card className="bg-card border-border">
              <CardContent className="p-8 sm:p-12">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
                    GROWNETIX was born from a simple observation: small businesses were being left 
                  ...
                  <p>
                    Today, GROWNETIX helps businesses transform their operations through sleek web 
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl sm:text-4xl font-bold mb-12 text-center">
              Why Choose <span className="text-gradient">GROWNETIX?</span>
            </h2>
